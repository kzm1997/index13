	...
	public static void main(String[] args) throws Exception {
		...
		Authenticator authenticator = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("1206960056@qq.com", "odbcsyeibtpdgjgh");
			}
		};
		...
		message.setFrom(new InternetAddress("1206960056@qq.com"));
		// 2.2 收件人 , to:收件人 ， cc ：抄送，bcc：暗送（密送）。（模拟账号）
		message.setRecipient(RecipientType.TO, new InternetAddress("kzmdyx@sina.com"));
		// 2.3 主题
